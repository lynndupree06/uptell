...
<html lang="en">
   ...
   <nav class="navbar navbar-fixed-top navbar-inverse">
    ...
    <div class="row">
        ...
        <hr />
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 sidebar-offcanvas" id="sidebar">
 ...
 <div class="projectRow">
            <div class="col-md-4 portfolio-item">
                <a href="sampleproject.php">
                    <img class="img-responsive" src="./img/houses/homeone.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="sampleproject.php"> Sample Video Project</a>
                </h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/hometwo.jpg" alt="Sample Image">
                </a>
                <h3>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
   			     ...
   			     <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homethree.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="sampleTextproject.php">Sample Text Project</a>
                </h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
        </div>
        ...
        <div class="projectRow">
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homefour.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="#">Project Name</a>
                </h3>
            ...
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homefive.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="#">Project Name</a>
                </h3>
            ...
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homesix.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="#">Project Name</a>
                </h3>
        ...
        <div class="projectRow">
          <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homeseven.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="#">Project Name</a>
                </h3>
            ...
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homeeight.png" alt="Sample Image">
                </a>
                <h3>
                    <a href="#">Project Name</a>
                </h3>
            ...
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="./img/houses/homenine.jpg" alt="Sample Image">
                </a>
                <h3>
                    <a href="#">Project Name</a>
                </h3>
